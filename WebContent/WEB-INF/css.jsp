...
input[type=submit].submit-tab-admin {
    font-family: 'Montserrat', Arial, Helvetica, sans-serif;
    float: right;
    width: 5.5%;
...
input[type=button].btn-result-parcours {
	font-family: 'Montserrat', Arial, Helvetica, sans-serif;
    border: #ccc1c1 solid 3px;
    background-color: #75a787;
    border: #ccc1c1 solid 3px;
...
input[type=button].btn-nouveau-parcours {
    font-family: 'Montserrat', Arial, Helvetica, sans-serif;
    border: #ccc1c1 solid 3px;
    background-color: #ff8f00;
    color: white;
...
.div-tab-quest, .div-tab-quizz, .div-tab-parcours, .div-tab-admin-attente, .div-tab-admin-valide {
    margin-top: 1%;
}
